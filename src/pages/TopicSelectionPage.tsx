...
const javaTopics = [
  ...
  { id: 'if_elif_else', number: '05', name: 'If Else If Ladder', subtitle: 'Grade System, Tax Slab, Positive/Negative, BMI & Bills', programsCount: 5, difficulty: 'Beginner' as const, category: 'basics', accentColor: '#4f46e5' },
  ...
  { id: 'for_loop', number: '07', name: 'For Loop Iteration', subtitle: 'Sum, Table, Fibonacci, Even Numbers & Power (base^exp)', programsCount: 5, difficulty: 'Intermediate' as const, category: 'loops', accentColor: '#06b6d4' },
  { id: 'while_loop', number: '08', name: 'While Loop Iteration', subtitle: 'Sum of Digits, Factorial, Reverse, Prime & Palindrome', programsCount: 5, difficulty: 'Intermediate' as const, category: 'loops', accentColor: '#0891b2' },
  { id: 'do_while_loop', number: '09', name: 'Do-While Loop', subtitle: 'Exit-controlled Guaranteed Run & Accumulator Loop', programsCount: 2, difficulty: 'Intermediate' as const, category: 'loops', accentColor: '#0284c7' },
  { id: 'strings', number: '10', name: 'Strings & Character Encoding', subtitle: 'Char to ASCII Code & String Concatenation Length', programsCount: 2, difficulty: 'Intermediate' as const, category: 'data', accentColor: '#8b5cf6' },
