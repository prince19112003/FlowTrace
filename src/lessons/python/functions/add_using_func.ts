...
export const add_using_func: LessonProgram = {
  ...
  lines: [
    ...
    { lineNum: 4, tokens: [{ type: 'variable', value: 'num1' }, { type: 'text', value: ' ' }, { type: 'operator', value: '=' }, { type: 'text', value: ' ' }, { type: 'parameter', value: '15', paramId: 'num1' }] },
    { lineNum: 5, tokens: [{ type: 'variable', value: 'num2' }, { type: 'text', value: ' ' }, { type: 'operator', value: '=' }, { type: 'text', value: ' ' }, { type: 'parameter', value: '20', paramId: 'num2' }] },
  ...
  generateSteps: ({ num1, num2 }): ExecutionStep[] => {
    ...
    return [
      {
        step: 1, lineNum: 1,
        explanationEnglish: 'Define add(a, b) — a reusable recipe that knows how to add two numbers.',
        explanationHinglish: 'add(a, b) function banaya — ek recipe jo do numbers jodna jaanti hai.',
        memorySnapshot: {},
        animationEvent: { type: 'NONE' },
      },
      {
        step: 2, lineNum: 4,
        explanationEnglish: `Store ${n1} in num1.`,
        explanationHinglish: `num1 mein ${n1} dala.`,
        memorySnapshot: { num1: n1 },
        animationEvent: { type: 'CREATE_VARIABLE', name: 'num1', value: n1 },
      },
      {
        step: 3, lineNum: 5,
        explanationEnglish: `Store ${n2} in num2.`,
        explanationHinglish: `num2 mein ${n2} dala.`,
        memorySnapshot: { num1: n1, num2: n2 },
        animationEvent: { type: 'CREATE_VARIABLE', name: 'num2', value: n2 },
      },
      {
        step: 4, lineNum: 6,
        explanationEnglish: `Call add(num1, num2) — sending ${n1} and ${n2} into the function.`,
        explanationHinglish: `add(num1, num2) call kiya — ${n1} aur ${n2} function ko bheje.`,
        memorySnapshot: { num1: n1, num2: n2 },
        animationEvent: { type: 'FUNCTION_CALL', functionName: 'add', args: { a: n1, b: n2 } },
      },
      {
        step: 5, lineNum: 1,
        explanationEnglish: `Parameters receive values: a = ${n1}, b = ${n2}. Function is now executing.`,
        explanationHinglish: `Parameters mein values aayi: a = ${n1}, b = ${n2}. Function chal raha hai.`,
        memorySnapshot: { num1: n1, num2: n2, a: n1, b: n2 },
        animationEvent: { type: 'CREATE_VARIABLE', name: 'a', value: n1 },
      },
      {
        step: 6, lineNum: 2,
        explanationEnglish: `Compute a + b = ${n1} + ${n2} = ${result}, and return the result.`,
      ...
      {
        step: 8, lineNum: 7,
        explanationEnglish: `Print the final sum: ${result}.`,
        explanationHinglish: `Final sum print kiya: ${result}.`,
        memorySnapshot: { num1: n1, num2: n2, ans: result },
