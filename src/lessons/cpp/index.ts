...
export const cpp_types = createCppLesson(
  ...
  'C++ Primitive Data Types (int, double, bool, char)',
  ...
  [
    ...
    { lineNum: 5, tokens: [{ type: 'text' as const, value: '    ' }, { type: 'keyword' as const, value: 'double' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'gpa' }, { type: 'text' as const, value: ' ' }, { type: 'operator' as const, value: '=' }, { type: 'text' as const, value: ' ' }, { type: 'number' as const, value: '3.85', paramId: 'gpa' }, { type: 'punctuation' as const, value: ';' }] },
  ...
  { count: { default: 10, label: 'count (int)' }, gpa: { default: 3.85, label: 'gpa (double)' } },
  (vars) => {
...
export const cpp_constants = createCppLesson(
  ...
  [
    ...
    { lineNum: 2, tokens: [{ type: 'keyword' as const, value: 'using' }, { type: 'text' as const, value: ' ' }, { type: 'keyword' as const, value: 'namespace' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'std' }, { type: 'punctuation' as const, value: ';' }] },
    { lineNum: 3, tokens: [{ type: 'keyword' as const, value: 'int' }, { type: 'text' as const, value: ' ' }, { type: 'function' as const, value: 'main' }, { type: 'punctuation' as const, value: '()' }, { type: 'text' as const, value: ' {' }] },
    { lineNum: 4, tokens: [{ type: 'text' as const, value: '    ' }, { type: 'keyword' as const, value: 'const' }, { type: 'text' as const, value: ' ' }, { type: 'keyword' as const, value: 'double' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'PI' }, { type: 'text' as const, value: ' ' }, { type: 'operator' as const, value: '=' }, { type: 'text' as const, value: ' ' }, { type: 'number' as const, value: '3.14159' }, { type: 'punctuation' as const, value: ';' }] },
    { lineNum: 5, tokens: [{ type: 'text' as const, value: '    ' }, { type: 'keyword' as const, value: 'double' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'radius' }, { type: 'text' as const, value: ' ' }, { type: 'operator' as const, value: '=' }, { type: 'text' as const, value: ' ' }, { type: 'number' as const, value: '7.0' }, { type: 'punctuation' as const, value: ';' }] },
    { lineNum: 6, tokens: [{ type: 'text' as const, value: '    ' }, { type: 'keyword' as const, value: 'double' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'area' }, { type: 'text' as const, value: ' ' }, { type: 'operator' as const, value: '=' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'PI' }, { type: 'text' as const, value: ' ' }, { type: 'operator' as const, value: '*' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'radius' }, { type: 'text' as const, value: ' ' }, { type: 'operator' as const, value: '*' }, { type: 'text' as const, value: ' ' }, { type: 'variable' as const, value: 'radius' }, { type: 'punctuation' as const, value: ';' }] },
  ...
  {},
  () => [
    { step: 1, lineNum: 4, explanationEnglish: 'Declare const double PI = 3.14159.', explanationHinglish: 'PI read-only constant memory me initialize hua.', memorySnapshot: { PI: '3.14159 [const]' }, animationEvent: { type: 'CREATE_VARIABLE', name: 'PI', value: 3.14159 } },
    { step: 2, lineNum: 6, explanationEnglish: 'Compute area = 153.94.', explanationHinglish: 'PI * r * r calculate hua.', memorySnapshot: { PI: '3.14159 [const]', radius: '7.0 [8B]', area: '153.94 [8B]' }, animationEvent: { type: 'CREATE_VARIABLE', name: 'area', value: 153.94 } },
    { step: 3, lineNum: 7, explanationEnglish: 'cout prints Area: 153.94.', explanationHinglish: 'Console pe Area: 153.94 display hua.', memorySnapshot: { PI: '3.14159 [const]', radius: '7.0 [8B]', area: '153.94 [8B]' }, consoleOutput: 'Area: 153.94', animationEvent: { type: 'PRINT_VALUE', variableName: 'area', outputValue: '153.94' } }
  ]
);
