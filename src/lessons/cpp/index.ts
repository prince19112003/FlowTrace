...
export const cpp_constants = createCppLesson(
  ...
  () => [
    ...
    { step: 3, lineNum: 6, explanationEnglish: 'Compute area = PI * radius * radius = 153.9384.', explanationHinglish: 'area = 3.1416 * 7.0000 * 7.0000 = 153.9384 calculate hua.', memorySnapshot: { PI: '3.1416 [const]', radius: '7.0000 [4B]', area: '153.9384 [4B]' }, animationEvent: { type: 'CREATE_VARIABLE', name: 'area', value: '153.9384', formula: 'area = 3.1416 * 7.0000 * 7.0000 = 153.9384' } },
